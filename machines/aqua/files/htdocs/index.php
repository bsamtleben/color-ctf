...
<body>
    <nav>
        <a class="brandName scrollLink" scrolllink="#header">AQUA</a>
    ...
    <header id="header">
        <h1>Design made simple.<br>With AQUA.</h1>
        <ul class="takeActionBtns">
            <a scrolllink="#download" class="download scrollLink">Download</a>
    ...
    <section id="about">
        ...
        <p>Quality design requires quality design software. Are you wondering where to find the best design software in the world? The answer is simple: Just scroll down a little bit...</p>
        <br>
    ...
    <section id="vision">
        ...
        <div class="row">
            <div class="col">
                ...
                <h1>Great Quality</h1>
                <p>Our software is designed to match the highest industry standards.</p>
            </div>
            <div class="col">
                ...
                <h1>Up to Date</h1>
                <p>Regular updates help us to keep up with recent developments in the design industry.</p>
            </div>
            <div class="col">
                ...
                <h1>Responsive</h1>
                <p>Have you ever heard of responsiveness? That's the holy blockchain of design principles.</p>
            </div>
        </div>
    </section>
    ...
    <section id="download">
        ...
        <div class="lineContainer"><div class="line"></div></div>
        <p>You are interested in our product? Unfortunately, there is no trial version available at the moment. But don't worry! You can purchase our state-of-the-art Aqua design software right here. This offer is only valid for a limited time!</p>
        <br>
        <a href="#">Purchase for $3,999</a>
    </section>

    <section id="contact">
        <h1 class="headerLine">Contact Us</h1>
        <div class="lineContainer"><div class="line"></div></div>
        <p class="desc">If you have any further questions, please feel free to reach out to our sales team via phone or email. Make sure to also check out our social media links below!</p>
        <ul class="contactInfo">
            ...
            <li>
                ...
                <br>
                <p><a href="mailto:aqua-design@example.com" target="_top">aqua-design@example.com</a></p>
            </li>
        </ul>
    </section>
